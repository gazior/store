...
<div class="container-fluid bg-warning mb-5">
    <div class="row">
        <nav class="navbar nav-masthead navbar-dark navbar-expand-lg justify-content-center float-md-end bg-dark bg-gradient text-warning">
            <div class="container-fluid">
                <a class="navbar-brand fw-bold py-1 px-1" href="#">Store</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link fw-bold py-1 px-1 nav-link" aria-current="page" href="/">Strona Główna</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold py-1 px-1 nav-link" href="/products">Produkty</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold py-1 px-1 nav-link" href="/account">Twoje konto</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold py-1 px-1 nav-link" href="/orders">Historia zamówień</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold py-1 px-1 nav-link" href="/cart">Pokaż koszyk</a>
                        </li>
                    </ul>
